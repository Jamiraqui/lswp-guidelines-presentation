...
export default function Home() {
  ...
  return <div className="app">
    ...
    <main>
      ...
      <section id="tracks"><Title n="08" kicker="APPLICATION TRACKS" title="Urgency changes speed, not accountability."/><div className="track-grid"><Track urgent/><Track/></div><div className="callout"><Icon name="✓"/><p><b>Approval rule for both tracks</b><br/>Approval requires at least 2 of the 3 voting Committee members. Once approved, the Academic Support Coordinator forwards the approved application form to the Dean of Student Affairs.</p></div></section>
      ...
      <section id="governance"><Title n="10" kicker="SCREENING · APPROVAL · DISBURSEMENT" title="Separate judgment, release, and accountability."/><div className="flow"><div><span>1</span><b>Intake</b><small>Completeness & verification</small></div><i>→</i><div><span>2</span><b>Committee review</b><small>Score, conflict check, record</small></div><i>→</i><div><span>3</span><b>Approval</b><small>At least 2 of 3 voting members</small></div><i>→</i><div><span>4</span><b>Forwarding</b><small>Coordinator sends approved form to Dean</small></div><i>→</i><div><span>5</span><b>Disbursement</b><small>Direct pay preferred</small></div><i>→</i><div><span>6</span><b>Follow-up</b><small>Proof, ledger, referral</small></div></div><div className="govern-grid"><div><h3>Committee and quorum</h3><p>The three voting Committee members are the Associate Dean of Student Affairs, the Director of the Student Success Center, and the Academic Support Coordinator. The Dean of Student Affairs receives the approved application form after the Committee decision and is not a voting Committee member.</p><ul><li>Approval requires at least 2 of the 3 voting Committee members</li><li>The same 2-of-3 rule applies to regular, expedited, and provisional approvals</li><li>The Academic Support Coordinator certifies the approval on behalf of the approving voting Committee members</li><li>Conflicted members disclose and recuse</li><li>No single person approves, releases, and liquidates end-to-end</li></ul></div><div><h3>After approval</h3><ul><li>The Academic Support Coordinator records the decision and approved amount</li><li>The Coordinator signs the approval certification on behalf of the approving voting Committee members</li><li>Once approved, the Academic Support Coordinator forwards the approved application form to the Dean of Student Affairs</li><li>The approved form then proceeds to the applicable disbursement and finance controls</li></ul></div><div><h3>Decision record</h3><ul><li>Identity, program, and enrollment status</li><li>Category, request, approval, and funding source</li><li>Track, evidence, interview/testimony, and score</li><li>Reason for decision or referral</li><li>Payee, liquidation, and follow-up date</li></ul></div><div><h3>Disbursement controls</h3><ul><li>Direct provider payment when practical</li><li>Proportionate receipt, acknowledgement, or attestation</li><li>Flag duplicate payees, receipts, expenses, and unusual recommender clusters</li><li>Live ledger of envelope, commitments, releases, pending cases, and balance</li></ul></div></div></section>
      ...
      <section id="appendices"><Title n="A–D" kicker="IMPLEMENTATION KIT" title="Ready-to-use forms and process aids."/><div className="appendix-grid">
        <article><span>A</span><h3>Process summary</h3><p>Side-by-side triggers, intake, interview, decision targets, safeguards, approval, and forwarding steps for both tracks.</p></article>
        <article className="form-card"><span>B</span><h3>Google Form (Application)</h3><p>Submit the LSWP Aid application and supporting information through the official form.</p><a className="form-link" href="https://docs.google.com/forms/d/e/1FAIpQLSeRBNplIPFlhRaIUao0wq9WydiV9Fj8xC_4VZg628U-agITfA/viewform?usp=header" target="_blank" rel="noreferrer">Open application form <Icon name="↗"/></a></article>
        <article><span>C</span><h3>Application letter</h3><p>Identity, enrollment, category, need, amount, other support, declarations, consent, attachments, and Committee certification.</p></article>
        <article><span>D</span><h3>Character testimony</h3><p>Recommender identity, relationship, direct knowledge, need, conflict declaration, attestation, verification consent, and signature.</p></article>
      </div><div className="track-summary"><div><b>EXPEDITED</b><span>Urgent + credible testimony</span><strong>1–3 working days</strong><small>Approval requires at least 2 of the 3 voting Committee members, including any provisional release. Once approved, the Academic Support Coordinator forwards the approved application form to the Dean of Student Affairs.</small></div><div><b>REGULAR</b><span>No recommender / non-urgent / fuller review</span><strong>5 working days</strong><small>Approval requires at least 2 of the 3 voting Committee members. Once approved, the Academic Support Coordinator forwards the approved application form to the Dean of Student Affairs before applicable disbursement processing.</small></div></div>
        <div className="application-template">
          <div className="template-head"><small>APPENDIX C</small><h3>Application Letter</h3></div>
          <p>[Date]</p><p><b>LSWP Committee</b><br/>Lasallian Student Welfare Program Aid<br/>De La Salle University</p><p><b>Subject: Application for LSWP Aid</b></p><p>Dear Members of the LSWP Committee:</p><p>I am writing to respectfully apply for assistance under the Lasallian Student Welfare Program Aid.</p><p>My name is ______________________________, a student of ______________________________ under the program ____________________. My Student ID Number is ____________________. I am currently enrolled for ______________________________.</p><p>I am requesting assistance under the following category:</p><p>[&nbsp;&nbsp;] Student Emergency Health Aid<br/>[&nbsp;&nbsp;] Student Life Assistance Program<br/>[&nbsp;&nbsp;] Student Emergency Relief Fund</p><p>I am requesting support because:<br/><span className="blank-line"/><span className="blank-line"/></p><p>The amount I am requesting is PHP ____________________. The assistance will be used for:<br/><span className="blank-line"/></p><p>I confirm that the information and documents I submitted are true and accurate; I will use approved aid only for its stated purpose; I will provide proof of use if required; I have disclosed prior aid for the same need; and I consent to verification for the evaluation of this application.</p>
          <div className="student-signature"><p>Respectfully,</p><p><span className="signature-line"/><br/>Signature over Printed Name</p><p>Student ID No.: ____________________<br/>Program/College: ____________________<br/>DLSU Email: ____________________<br/>Contact No.: ____________________</p></div>
          <div className="committee-use"><h4>FOR LSWP COMMITTEE USE ONLY</h4><p><b>Committee Action:</b><br/>[&nbsp;&nbsp;] Approved&nbsp;&nbsp; [&nbsp;&nbsp;] Disapproved&nbsp;&nbsp; [&nbsp;&nbsp;] Deferred / For referral</p><h5>Approval Certification</h5><p>This application has been reviewed and approved by at least 2 of the 3 voting Committee members.</p><p>Approved Amount: PHP ______________________<br/>Approved Aid Category: ______________________________<br/>Remarks / Conditions: ________________________________________________</p><p>Certified and signed on behalf of the approving voting Committee members by:</p><p><b>Academic Support Coordinator</b><br/>Signature over Printed Name: ______________________________<br/>Date: ______________________</p></div>
        </div>
      </section>
